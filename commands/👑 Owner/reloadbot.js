  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let tempmsg = await message.channel.send(new MessageEmbed()
        ...
        .setAuthor("Reloading ...", "https://images-ext-1.discordapp.net/external/ANU162U1fDdmQhim_BcbQ3lf4dLaIQl7p0HcqzD5wJA/https/cdn.discordapp.com/emojis/756773010123522058.gif", "https://discord.gg/caxGNajAKJ")
      ...
      await tempmsg.edit({embed: new MessageEmbed()
        .setColor(es.color).setFooter(es.footertext, es.footericon)
        .setAuthor("Successfully Reloaded:", "https://cdn.discordapp.com/emojis/833101995723194437.gif?v=1", "https://discord.gg/caxGNajAKJ")
