    ...
    try {
      ...
      if (temptype == "channel") {
                ...
                .then(collected => {
                  ...
                  if (channel) {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`✔️ The new leave Cannel is: \`${channel.name}\``)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle("❌ ERROR | Something went wrong, please contact: `[𝗔𝗭𝗜𝗭 𝗞𝗔𝗠𝗠𝗢𝗨𝗡]#7812`")
                        .setColor(es.wrongcolor)
            ...
            //Disable - CHANNEL
              ...
              try {
                ...
                return reaction.message.channel.send(new Discord.MessageEmbed()
                  .setTitle(`✔️ Disabled the leave **Message**`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                ...
                .then(async collected => {
                  ...
                  if (reaction.emoji.name === "1️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`✔️ I will now send no Image with the leave Message`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  ...
                  if (reaction.emoji.name === "2️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`✔️ I will now send an Image with the leave Message`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                      ...
                      .then(collected => {
                        ...
                        if (collected.first().attachments.size > 0) {
                          if (collected.first().attachments.every(attachIsImage)) {
                            ...
                            return reaction.message.channel.send(new Discord.MessageEmbed()
                              .setTitle(`✔️ I will now use your Custom Background image`)
                              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                              .setDescription(`I will be using ${client.settings.get(message.guild.id, "leave.custom") === "no" ? "an Auto generated Image with User Data": "Your defined, custom Image" }\n\nIf Someone joins this Server, a message **with an image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                              .setFooter(es.footertext, es.footericon)
                            );
                  ...
                  if (reaction.emoji.name === "4️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`✔️ I will now send an Auto generated Image with an transparent Background, including your Guild Avatar`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                      ...
                      .then(collected => {
                        ...
                        if (collected.first().attachments.size > 0) {
                          if (collected.first().attachments.every(attachIsImage)) {
                            ...
                            return reaction.message.channel.send(new Discord.MessageEmbed()
                              .setTitle(`✔️ I will now use your Custom image`)
                              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                              .setDescription(`I will be using ${client.settings.get(message.guild.id, "leave.custom") === "no" ? "an Auto generated Image with User Data": "Your defined, custom Image" }\n\nIf Someone joins this Server, a message **with an image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                              .setFooter(es.footertext, es.footericon)
                            );
                  ...
                  if (reaction.emoji.name === "6️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`✔️ ${client.settings.get(message.guild.id, "leave.frame") ? "Enabled the Frame for the Automated leave Image" : "Disabled the Frame for the Automated leave Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  ...
                  if (reaction.emoji.name === "7️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`✔️ ${client.settings.get(message.guild.id, "leave.discriminator") ? "Enabled the Discrimantor (4 Numbers with #) for the Automated leave Image" : "Disabled the Discrimantor (4 Numbers with #) for the Automated leave Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "8️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`✔️ ${client.settings.get(message.guild.id, "leave.membercount") ? "Enabled the MemberCount Text for the Automated leave Image" : "Disabled the MemberCount Text for the Automated leave Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "9️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`✔️ ${client.settings.get(message.guild.id, "leave.servername") ? "Enabled Servername Text Frame for the Automated leave Image" : "Disabled the Servername Text for the Automated leave Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "🔟") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`✔️ ${client.settings.get(message.guild.id, "leave.pb") ? "Enabled Profile Picture for the Automated leave Image" : "Disabled Profile Picture for the Automated leave Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                    ...
                    await tempmsg.awaitReactions(filter, {
                      ...
                      .then(async collected => {
                        ...
                        try {
                          ...
                          return message.reply(new Discord.MessageEmbed()
                            .setTitle(`✔️ CHANGED THE COLOR FOR THE FRAME`)
                            .setColor(color)
                            .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                            .setFooter(es.footertext, es.footericon)
                          );
              ...
              await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
                ...
                .then(collected => {
                  ...
                  try {
                    ...
                    return message.reply(new Discord.MessageEmbed()
                      .setTitle(`✔️ The new leave Message is:`)
                      .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          ...
          .then(async collected => {
            ...
            if (reaction.emoji.name === "1️⃣") {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`✔️ I will now send leave-Messages to a new User in his DMS`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setFooter(es.footertext, es.footericon)
                );
              } catch (e) {
            ...
            //Disable - CHANNEL
              ...
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`✔️ I will now send **NO** leave-Messages to a new User in his DMS`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setFooter(es.footertext, es.footericon)
                );
              } catch (e) {
                ...
                .then(async collected => {
                  ...
                  if (reaction.emoji.name === "1️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`✔️ I will now send no Image with the leave Message (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setFooter(es.footertext, es.footericon)
                      );
                    } catch (e) {
                  ...
                  if (reaction.emoji.name === "2️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`✔️ I will now send an Image with the leave Message (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setFooter(es.footertext, es.footericon)
                      );
                    } catch (e) {
                      ...
                      .then(collected => {
                        ...
                        if (collected.first().attachments.size > 0) {
                          if (collected.first().attachments.every(attachIsImage)) {
                            ...
                            return reaction.message.channel.send(new Discord.MessageEmbed()
                              .setTitle(`✔️ I will now use your Custom Background image (dm)`)
                              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  ...
                  if (reaction.emoji.name === "4️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`✔️ I will now send an Auto generated Image with an transparent Background, including your Guild Avatar (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setFooter(es.footertext, es.footericon)
                      );
                    } catch (e) {
                      ...
                      .then(collected => {
                        ...
                        if (collected.first().attachments.size > 0) {
                          if (collected.first().attachments.every(attachIsImage)) {
                            ...
                            return reaction.message.channel.send(new Discord.MessageEmbed()
                              .setTitle(`✔️ I will now use your Custom image (DM)`)
                              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                              .setDescription(`I will be using ${client.settings.get(message.guild.id, "leave.customdm") === "no" ? "an Auto generated Image with User Data": "Your defined, custom Image" }`.substr(0, 2048))
                              .setFooter(es.footertext, es.footericon)
                            );
                  ...
                  if (reaction.emoji.name === "6️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`✔️ ${client.settings.get(message.guild.id, "leave.framedm") ? "Enabled the Frame for the Automated leave Image" : "Disabled the Frame for the Automated leave Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setFooter(es.footertext, es.footericon)
                      );
                    } catch (e) {
                  ...
                  if (reaction.emoji.name === "7️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`✔️ ${client.settings.get(message.guild.id, "leave.discriminatordm") ? "Enabled the Discrimantor (4 Numbers with #) for the Automated leave Image" : "Disabled the Discrimantor (4 Numbers with #) for the Automated leave Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "8️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`✔️ ${client.settings.get(message.guild.id, "leave.membercountdm") ? "Enabled the MemberCount Text for the Automated leave Image" : "Disabled the MemberCount Textthe Automated leave Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "9️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`✔️ ${client.settings.get(message.guild.id, "leave.servernamedm") ? "Enabled Servername Text Frame for the Automated leave Image" : "Disabled the Servername Text for the Automated leave Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "🔟") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`✔️ ${client.settings.get(message.guild.id, "leave.pbdm") ? "Enabled Profile Picture for the Automated leave Image" : "Disabled Profile Picture for the Automated leave Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                    ...
                    await tempmsg.awaitReactions(filter, {
                      ...
                      .then(async collected => {
                        ...
                        try {
                          ...
                          return message.reply(new Discord.MessageEmbed()
                            .setTitle(`✔️ CHANGED THE COLOR FOR THE FRAME (DM)`)
                            .setColor(color)
                            .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                            .setFooter(es.footertext, es.footericon)
                          );
              ...
              await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
                ...
                .then(collected => {
                  ...
                  try {
                    ...
                    return message.reply(new Discord.MessageEmbed()
                      .setTitle(`✔️ The new leave Message is: (DM)`)
                      .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
        ...
        *React with the Right Emoji according to the Right action*`)
              ...
              await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
                ...
                .then(collected => {
                  ...
                  if (role) {
                    ...
                    return message.reply(new Discord.MessageEmbed()
                      .setTitle(`✔️ The role: \`${role.name}\` is now registered as an leave Role`)
                      .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
              ...
              await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
                ...
                .then(collected => {
                  ...
                  if (role) {
                    ...
                    return message.reply(new Discord.MessageEmbed()
                      .setTitle(`✔️ Remove the role: \`${role.name}\` from the leave Roles`)
                      .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                      .setDescription(`Everyone who joins will get those Roles now:\n<@&${client.settings.get(message.guild.id, "leave.roles").join(">\n<@&")}>`.substr(0, 2048))
                      .setFooter(es.footertext, es.footericon)
                    );
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle("❌ ERROR | PLEASE CONTACT `[𝗔𝗭𝗜𝗭 𝗞𝗔𝗠𝗠𝗢𝗨𝗡]#7812`")
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
        );
      }
...
/**
 * @INFO
 * Bot Coded by [𝗔𝗭𝗜𝗭 𝗞𝗔𝗠𝗠𝗢𝗨𝗡]#7812 | https://github.com/Tomato6966/discord-js-lavalink-Music-Bot-erela-js
 * @INFO
