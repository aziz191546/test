            ...
            await pickmsg.awaitReactions((reaction, user) => user.id === message.author.id, {
                ...
                case "editquestion": {
                  ...
                  var embed = new Discord.MessageEmbed()
                    ...
                    .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                    .setTitle("Current Questions") //[𝗔𝗭𝗜𝗭 𝗞𝗔𝗠𝗠𝗢𝗨𝗡]#1919
                        ...
                        message.channel.send(new Discord.MessageEmbed().setFooter(es.footertext, es.footericon).setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setAuthor("What should be the new Question?", message.author.displayAvatarURL({
                          ...
                          msg.channel.awaitMessages(m => m.author.id === message.author.id, {
                            ...
                            var new_embed = new Discord.MessageEmbed().setFooter(es.footertext, es.footericon)
                              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                              .setTitle("NEW Questions") //[𝗔𝗭𝗜𝗭 𝗞𝗔𝗠𝗠𝗢𝗨𝗡]#1919
                ...
                case "last_verify": {
                  ...
                  var embed = new Discord.MessageEmbed()
                    .setFooter(es.footertext, es.footericon)
                    .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                    .setTitle(`${apply_for_here.get(message.guild.id, "last_verify") ? "Enabled Last Verification": "Disabled Last Verification"}`) //[𝗔𝗭𝗜𝗭 𝗞𝗔𝗠𝗠𝗢𝗨𝗡]#1919
                    .setDescription(`${apply_for_here.get(message.guild.id, "last_verify") ? "I will now ask the User a last Time if he really wanna apply for the Server": "I will not ask the User"}`) //[𝗔𝗭𝗜𝗭 𝗞𝗔𝗠𝗠𝗢𝗨𝗡]#1919
                    .setTimestamp()
                  message.channel.send(embed);
                }
                break;
...
/**
 * @INFO
 * Bot Coded by [𝗔𝗭𝗜𝗭 𝗞𝗔𝗠𝗠𝗢𝗨𝗡]#1919 | https://github.com/Tomato6966/Discord-Js-Handler-Template
 * @INFO
