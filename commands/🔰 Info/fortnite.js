...
const config = require('../../botconfiga.json');
...
module.exports = {
    ...
    if (!username) return message.reply('Usage: *fortnite <username> <gamemode> <platform>');
    ...
    let data = fortnite.user(username, platform).then(data => {
        ...
        console.log(e);
        message.channel.send('Usage: *fortnite <username> <gamemode> <platform>');
    });
}
}