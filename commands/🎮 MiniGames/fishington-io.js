...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        .setColor("#FF0000")
        .setDescription(`
Using **fishington-io Game** you can Play with your friends in a Voice Channel. Click *Join fishington-io Game* to join in!

__**[Join fishington-io Game](https://discord.com/invite/${invite.code})**__
