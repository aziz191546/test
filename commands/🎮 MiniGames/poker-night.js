...
module.exports = {
    ...
    description: 'Starts a poker-night session',
    usage: '',
    /** 
     * @param {Client} client 
    ...
    run: async (client, message, args) => {
        ...
        .setColor("#FF0000")
        .setDescription(`
Using **poker-night Game** you can Play with your friends in a Voice Channel. Click *Join poker-night Game* to join in!

__**[Join poker-night Game](https://discord.com/invite/${invite.code})**__
