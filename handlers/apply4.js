      ...
      try {
        ...
        function ask_question(qu) {
          ...
          user.send(new Discord.MessageEmbed()
              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
              .setDescription(qu)
              .setAuthor(`Question ${counter + 1} / ${Questions.length}`, client.user.displayAvatarURL(), "https://discord.com/api/oauth2/authorize?client_id=863020946030067722&permissions=8&scope=bot")
              .setFooter(es.footertext, es.footericon)
            ).then(msg => {
