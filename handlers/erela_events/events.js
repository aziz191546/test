      ...
      client.manager
        .on("playerCreate", async (player) => {
            ...
            try {
              ...
              embed.addField(`👑 Music Powered by https://www.bestbot.xyz/`, `**[Invite Bot](https://discord.com/api/oauth2/authorize?client_id=863020946030067722&permissions=8&scope=bot)  •  [WEBSITE](https://www.bestbot.xyz/)  •  [Support Server](https://discord.gg/caxGNajAKJ)**`)
            } catch {}
