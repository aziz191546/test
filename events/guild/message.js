            ...
            //Check if there is a Dj Setup
              ...
              let leftb = "";
                ...
                //if not a DJ and not a nAdmin
                  ...
                  if(!player){
                    try{ message.react("🤷🏾‍♂️").catch(e => console.log("couldn't react this is a catch to prevent a crash".grey)); }catch{}
                    not_allowed = true;
                      return message.channel.send(new Discord.MessageEmbed()
